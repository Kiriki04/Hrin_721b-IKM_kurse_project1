    ...
    internal class MajorWork
    {
        ...
        public void SaveToFile() // Запис даних до файлу
        {
            ...
            try
            {
                ...
                D.Key = Key;
                BinaryFormatter BF = new BinaryFormatter(); // створення об'єкта дляформатування BF.Serialize(S, D);
            ...
            catch
            {
                ...
                MessageBox.Show("Помилка роботи з файлом"); // Виведення на екран повідомлення "Помилкароботи з файлом"
            }
        }
